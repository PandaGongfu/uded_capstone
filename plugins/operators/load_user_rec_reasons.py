...
class LoadUserRecReasonOperator(BaseOperator):
    ui_color = '#AED6F1'
    ...
    def __init__(self,
        ...
        super(LoadUserRecReasonOperator, self).__init__(*args, **kwargs)
        self.table = table
    ...
    def execute(self, context):
        ...
        update_query = f"""
        INSERT INTO graph_recs.{self.table} (user_id, rec_id, reason_id, type, weight, created_at, updated_at)
        SELECT t.user_id, t.rec_id, t.reason_id, 'user', t.weight, current_timestamp, current_timestamp FROM graph_recs.tt_user_rec_reasons t
        ON CONFLICT (user_id, rec_id, reason_id, type) 
